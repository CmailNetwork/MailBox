...
import {InboxNavType} from "../Inbox/Nav";
...
export const SideMenu: React.FC = () => {
  ...
  return (
    <Flex position="absolute" alignItems="center" direction="column" left="0" top="100px" w="200px">
      <ButtonList items={btns} />
    </Flex>
  )
}
...
export const Navbar: React.FC<NavbarProps> = () => (
  <NavbarContainer>
      <SideMenu />
        ...
        <Flex alignItems="center" position="absolute" right={0} w={400}>
          <ConnectWallet
